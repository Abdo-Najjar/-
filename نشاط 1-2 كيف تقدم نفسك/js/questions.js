 ...
 //loading the Questions
  ...
  $("#ch4").text(questions[qn].op4);
    ...
    $("#1,#change").click(function(){
      "use strict"
     var src = ($("#selectImg").attr('src') === 'imags/unmute.png')?'imags/mute.png':'imags/unmute.png';
     $("#selectImg").attr('src' , src) ;
     if(src == "imags/unmute.png"){
      questionAudio.play();
     }else{
      chooseAudio.pause();
      questionAudio.pause();
   ...
   $("#choose4").on('click' , ()=>{
     ...
     switch(qn){
      case 0:
       $(".q1").css("background-color", "#34C7A9");
       $(".q1").css("color", "white");

      break;
      case 1:
       $(".q1").css("background-color", "#34C7A9");
       $(".q2").css("background-color", "#34C7A9");
       $(".q1").css("color", "white");
       $(".q2").css("color", "white");
      ...
      case 2:
       $(".q1").css("background-color", "#34C7A9");
       $(".q2").css("background-color", "#34C7A9");
       $(".q3").css("background-color", "#34C7A9");
       $(".q1").css("color", "white");
       $(".q2").css("color", "white");
       $(".q3").css("color", "white");
      ...
      case 3:
       ...
       $(".q2").css("background-color", "#34C7A9");
       $(".q3").css("background-color", "#34C7A9");
       $(".q4").css("background-color", "#34C7A9");
       $(".q1").css("color", "white");
       $(".q2").css("color", "white");
       $(".q3").css("color", "white");
       $(".q4").css("color", "white");
